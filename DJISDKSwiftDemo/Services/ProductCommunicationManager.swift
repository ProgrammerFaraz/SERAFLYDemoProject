...
class ProductCommunicationManager: NSObject {
    ...
    // MARK:- Set this value to true to use the app with the Bridge and false to connect directly to the product
    let enableBridgeMode = false
    
    // MARK:- When enableBridgeMode is set to true, set this value to the IP of your bridge app.
